...
<html lang="en">
    <head>
        ...
        <style type="text/css">
          /* Gmail Web hack: Gmail inserts <u> before email body */
          u + .e-body { background-color: #080808 !important; }
          u + .e-body .e-outer { background-color: #080808 !important; }
          u + .e-body .e-card { background-color: #0e0c08 !important; }
          u + .e-body .e-header { background-color: #131008 !important; }
          u + .e-body .e-content { background-color: #0e0c08 !important; }
          u + .e-body .e-footer { background-color: #0a0906 !important; }
          /* Gmail App dark mode selectors */
          [data-ogsc] .e-body, [data-ogsc] .e-outer { background-color: #080808 !important; }
          [data-ogsc] .e-card { background-color: #0e0c08 !important; }
          [data-ogsc] .e-header { background-color: #131008 !important; }
          [data-ogsc] .e-content { background-color: #0e0c08 !important; }
          [data-ogsc] .e-footer { background-color: #0a0906 !important; }
          /* Apple Mail / Samsung Mail */
          @media (prefers-color-scheme: dark) {
            .e-body, .e-outer { background-color: #080808 !important; }
            .e-card { background-color: #0e0c08 !important; }
            .e-header { background-color: #131008 !important; }
            .e-content { background-color: #0e0c08 !important; }
            .e-footer { background-color: #0a0906 !important; }
          }
        </style>
    ...
    <body class="e-body" style="margin: 0; padding: 0; background-color: #080808 !important;" bgcolor="#080808">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#080808" class="e-outer" style="background-color: #080808 !important; padding: 48px 16px;">
            <tr>
                <td align="center" bgcolor="#080808" class="e-outer" style="background-color: #080808 !important; padding: 0;">
                    <table role="presentation" cellpadding="0" cellspacing="0" bgcolor="#0e0c08" class="e-card" style="max-width: 580px; width: 100%; border-radius: 18px; border: 1px solid #f0d080; overflow: hidden; background-color: #0e0c08 !important;">
                        <tr>
                            <td align="center" bgcolor="#131008" class="e-header" style="background-color: #131008 !important; padding: 44px 48px 36px;">
                        ...
                        <tr><td bgcolor="#0e0c08" class="e-content" style="background-color: #0e0c08 !important; padding: 0 48px;"><div style="height: 1px; background-color: #1e1a10;"></div></td></tr>
                        <tr>
                            <td bgcolor="#0e0c08" class="e-content" style="background-color: #0e0c08 !important; padding: 36px 48px 12px;">
                        ...
                        <tr><td bgcolor="#0e0c08" class="e-content" style="background-color: #0e0c08 !important; padding: 0 48px;"><div style="height: 1px; background-color: #1e1a10;"></div></td></tr>
                        <tr>
                            <td bgcolor="#0a0906" class="e-footer" style="background-color: #0a0906 !important; padding: 22px 48px 30px;">
