...
<html lang="en">
    <head>
        ...
        <style>
          ...
          .body-wrap { background-color: #080808 !important; }
          @media (prefers-color-scheme: dark) {
            body, table, td, div { background-color: #080808 !important; }
          }
        </style>
    ...
    <body style="margin: 0; padding: 0; background-color: #080808" bgcolor="#080808">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#080808" class="body-wrap" style="background-color: #080808; padding: 48px 16px">
            <tr>
                <td align="center">
                    <table role="presentation" cellpadding="0" cellspacing="0" bgcolor="#0e0c08" style="max-width: 580px; width: 100%; border-radius: 18px; border: 1px solid #f0d080; overflow: hidden; background-color: #0e0c08;">
                        <tr>
                            <td align="center" style="background: linear-gradient(180deg, #131008 0%, #0e0c08 100%); padding: 44px 48px 36px;">
                        ...
                        <tr><td style="background-color: #0e0c08; padding: 0 48px;"><div style="height: 1px; background-color: #1e1a10;"></div></td></tr>
                        <tr>
                            <td style="background-color: #0e0c08; padding: 36px 48px 12px;">
                        ...
                        <tr>
                            <td style="background-color: #0e0c08; padding: 0 48px 36px;">
                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 14px"><tr><td width="26" valign="middle"><span style="display: inline-block; width: 20px; height: 20px; line-height: 20px; text-align: center; border-radius: 50%; background-color: rgba(201,168,76,0.12); border: 1px solid rgba(201,168,76,0.3); font-size: 12px; color: #c9a84c; font-family: Arial, sans-serif;">&#10003;</span></td><td style="padding-left: 12px; font-family: &quot;Space Grotesk&quot;, &quot;Arial&quot;, sans-serif; font-size: 14px; font-weight: 500; color: #c8c0ac; line-height: 1.5;">Free credits to bet with on launch</td></tr></table>
                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 14px"><tr><td width="26" valign="middle"><span style="display: inline-block; width: 20px; height: 20px; line-height: 20px; text-align: center; border-radius: 50%; background-color: rgba(201,168,76,0.12); border: 1px solid rgba(201,168,76,0.3); font-size: 12px; color: #c9a84c; font-family: Arial, sans-serif;">&#10003;</span></td><td style="padding-left: 12px; font-family: &quot;Space Grotesk&quot;, &quot;Arial&quot;, sans-serif; font-size: 14px; font-weight: 500; color: #c8c0ac; line-height: 1.5;">Squad rooms &amp; exclusive player cards</td></tr></table>
                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%"><tr><td width="26" valign="middle"><span style="display: inline-block; width: 20px; height: 20px; line-height: 20px; text-align: center; border-radius: 50%; background-color: rgba(201,168,76,0.12); border: 1px solid rgba(201,168,76,0.3); font-size: 12px; color: #c9a84c; font-family: Arial, sans-serif;">&#10003;</span></td><td style="padding-left: 12px; font-family: &quot;Space Grotesk&quot;, &quot;Arial&quot;, sans-serif; font-size: 14px; font-weight: 500; color: #c8c0ac; line-height: 1.5;">Massive promos &amp; drops every day</td></tr></table>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="background-color: #0e0c08; padding: 8px 48px 40px;">
                        ...
                        <tr><td style="background-color: #0e0c08; padding: 0 48px;"><div style="height: 1px; background-color: #1e1a10;"></div></td></tr>
                        <tr>
                            <td style="background-color: #0a0906; padding: 22px 48px 30px;">
